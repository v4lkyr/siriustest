...
CFLAGS_MODULE   = $(KERNELFLAGS) $(GRAPHITE)
AFLAGS_MODULE   = $(KERNELFLAGS) $(GRAPHITE)
LDFLAGS_MODULE  =
...
KBUILD_AFLAGS_KERNEL := $(KERNELFLAGS) $(GRAPHITE)
KBUILD_CFLAGS_KERNEL := $(KERNELFLAGS) $(GRAPHITE)
